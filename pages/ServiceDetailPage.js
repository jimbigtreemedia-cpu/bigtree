...
const ServiceDetailPage = () => {
    ...
    if (!service) {
        return _jsx(Navigate, { to: "/services", replace: true });
    }
            ...
            jsxs("div", { className: "relative max-w-7xl mx-auto px-6 lg:px-8", children: [
                    ...
                    jsxs("div", { className: "grid xl:grid-cols-[minmax(0,1fr)_330px] gap-8 mb-14 items-start", children: [
                            jsxs("div", { className: "space-y-6", children: [
                                    jsxs("div", { className: "relative rounded-3xl overflow-hidden bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 shadow-xl", children: [
                                            _jsx(CoverMedia, { src: service.image, alt: service.title, className: "w-full h-full object-cover", parentClassName: "aspect-square", priority: true, sizes: "(max-width: 1280px) 100vw" }),
                                    ...
                                    jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-3", children: [
                                            jsxs("div", { className: "rounded-xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-4", children: [
                                                    jsx("div", { className: "inline-flex p-2 rounded-lg bg-accent-teal/10 text-accent-teal mb-2", children: _jsx(Clock3, { size: 16 }) }),
                                            ...
                                            jsxs("div", { className: "rounded-xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-4", children: [
                                                    jsx("div", { className: "inline-flex p-2 rounded-lg bg-accent-gold/15 text-accent-gold mb-2", children: _jsx(ShieldCheck, { size: 16 }) }),
                                            ...
                                            jsxs("div", { className: "rounded-xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-4", children: [
                                                    jsx("div", { className: "inline-flex p-2 rounded-lg bg-primary/10 text-primary mb-2", children: _jsx(Sparkles, { size: 16 }) }),
                                            ...
                                            jsxs("div", { className: "rounded-xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-4", children: [
                                                    jsx("div", { className: "inline-flex p-2 rounded-lg bg-primary/10 text-primary mb-2", children: _jsx(CheckCircle, { size: 16 }) }),
                                    ...
                                    jsxs("div", { className: "grid lg:grid-cols-2 gap-6", children: [
                                            jsxs("article", { className: "bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/70 dark:border-slate-800 shadow-sm", children: [
                                                    ...
                                                    jsx("ul", { className: "space-y-3", children: service.deliverables.map((item) => jsxs("li", { className: "flex items-start gap-3", children: [
                                                                _jsx(CheckCircle, { size: 18, className: "text-primary dark:text-accent-teal mt-0.5 shrink-0" }),
                            ...
                            jsxs("aside", { className: "space-y-4 xl:sticky xl:top-24", children: [
                                    ...
                                    jsxs("div", { className: "rounded-3xl border border-slate-200/70 dark:border-slate-800 bg-white dark:bg-slate-900 p-6", children: [
                                            ...
                                            _jsx(Link, { to: primaryPortfolioLink, className: "w-full h-12 inline-flex items-center justify-center rounded-xl bg-primary text-white font-bold hover:bg-slate-800 dark:hover:bg-accent-teal transition-all shadow-lg shadow-primary/20", children: primaryPortfolioLabel }),
                                            _jsx(Link, { to: "/free-trial", className: "mt-3 w-full h-12 inline-flex items-center justify-center rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold hover:border-primary dark:hover:border-accent-teal hover:text-primary dark:hover:text-accent-teal transition-all", children: "Start Free Trial" }),
                                            _jsx(Link, { to: "/contact", className: "mt-3 w-full h-12 inline-flex items-center justify-center rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold hover:border-primary dark:hover:border-accent-teal hover:text-primary dark:hover:text-accent-teal transition-all", children: "Talk to Specialist" })
                                        ] })
                                ] })
                        ] }),
                    jsxs("section", { children: [
                            jsxs("div", { className: "flex items-center justify-between mb-6 gap-4", children: [
                                    ...
                                    _jsx(Link, { to: "/portfolio", className: "text-sm font-bold text-slate-500 hover:text-primary dark:text-slate-400 dark:hover:text-accent-teal transition-colors", children: "View All Portfolio" })
                                ] }),
                            jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: showcaseProjects.map((project) => {
                                    ...
                                    return jsxs(Link, { to: `/portfolio/${project.id}`, "data-analytics-cta": `service_detail_case_study_${project.id}`, "data-analytics-section": "service_detail_case_studies_grid", className: "group rounded-2xl overflow-hidden bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all", children: [
                                            jsxs("div", { className: "relative", children: [
                                                    _jsx(CoverMedia, { src: project.coverImage, alt: project.title, className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-500", parentClassName: "aspect-[4/3]" }),
                                                    (project.hasVideo || coverIsVideo) && jsx("div", { className: "absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 text-slate-900 flex items-center justify-center shadow-lg", children: _jsx(Play, { size: 13, fill: "currentColor", className: "ml-0.5" }) })
                                                ] }),
