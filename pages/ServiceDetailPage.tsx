...
const ServiceDetailPage = () => {
  ...
  const breakdownPoints = ["AI-assisted first pass for speed and consistency.", "Senior retoucher quality pass aligned to your brand style guide.", "Final QC checklist before delivery to ensure channel readiness.", "Structured output packaging for direct ecommerce and marketplace publishing."];
  if (!service) {
  ...
  return jsxs("section", {
    className: "relative py-20 md:py-24 bg-slate-50/70 dark:bg-slate-950 min-h-screen overflow-hidden",
    children: [jsx("div", {
      ...
      children: [jsxs(Link, {
        ...
        children: [jsxs("div", {
          ...
          children: [jsx("span", {
            ...
            children: segmentLabel || "Service"
          }), hasVideoShowcase && jsx("span", {
            className: "px-3 py-1 rounded-full border border-slate-200 dark:border-slate-700 bg-white/90 dark:bg-slate-900 text-[10px] font-bold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-300",
            children: "Image + Motion Ready"
          })]
        }), jsx("h1", {
          className: "text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4",
          children: service.title
        }), jsx("p", {
          className: "text-slate-600 dark:text-slate-300 text-lg leading-relaxed max-w-4xl",
          children: service.fullDescription
        })]
      }), jsxs("div", {
        className: "grid xl:grid-cols-[minmax(0,1fr)_330px] gap-8 mb-14 items-start",
        children: [jsxs("div", {
          className: "space-y-6",
          children: [jsxs("div", {
            className: "relative rounded-3xl overflow-hidden bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 shadow-xl",
            children: [/*#__PURE__*/React.createElement(CoverMedia, {
              ...
              children: [jsx("div", {
                ...
                children: service.tags.map(tag => jsx("span", {
                  className: "px-3 py-1 rounded-full bg-white/90 dark:bg-slate-900/90 backdrop-blur text-[10px] font-bold uppercase tracking-[0.14em] text-slate-600 dark:text-slate-300 border border-white/40",
                  children: tag
                }, tag))
              }), jsxs("div", {
                className: "hidden sm:flex flex-col items-end text-white text-xs font-bold uppercase tracking-[0.16em]",
                children: [jsx("span", {
                  className: "opacity-90",
                  children: "Case Studies"
                }), jsx("span", {
                  className: "text-lg leading-none",
                  children: relatedProjects.length
                })]
              })]
            })]
          }), jsxs("div", {
            ...
            children: [jsxs("div", {
              className: "rounded-xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-4",
              children: [jsx("div", {
                className: "inline-flex p-2 rounded-lg bg-accent-teal/10 text-accent-teal mb-2",
                children: /*#__PURE__*/React.createElement(Clock3, {
                  size: 16
                })
              }), jsx("p", {
                className: "text-xs font-bold uppercase tracking-wide text-slate-400 mb-1",
                children: "Typical SLA"
              }), jsx("p", {
              ...
              className: "rounded-xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-4",
              children: [jsx("div", {
                className: "inline-flex p-2 rounded-lg bg-accent-gold/15 text-accent-gold mb-2",
                children: /*#__PURE__*/React.createElement(ShieldCheck, {
                  size: 16
                })
              }), jsx("p", {
                className: "text-xs font-bold uppercase tracking-wide text-slate-400 mb-1",
              ...
              children: [jsx("div", {
                ...
                className: "text-sm font-semibold text-slate-700 dark:text-slate-200",
                children: [deliverableCount, " items"]
              })]
            })]
          }), jsxs("div", {
            className: "grid lg:grid-cols-2 gap-6",
            children: [jsxs("article", {
              className: "bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/70 dark:border-slate-800 shadow-sm",
              children: [jsx("h2", {
                className: "text-2xl font-bold text-slate-900 dark:text-white mb-4",
                children: "What Is Included"
              }), jsx("ul", {
                className: "space-y-3",
                children: service.deliverables.map(item => jsxs("li", {
                  className: "flex items-start gap-3",
                  children: [/*#__PURE__*/React.createElement(CheckCircle, {
                    size: 18,
                    className: "text-primary dark:text-accent-teal mt-0.5 shrink-0"
                  }), jsx("span", {
              ...
              children: [jsx("h2", {
                ...
                className: "space-y-3",
                children: breakdownPoints.map((point, index) => jsxs("li", {
                  className: "rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 p-4",
                  children: [jsxs("p", {
          ...
          children: [jsxs("div", {
            ...
            children: [jsx("h3", {
              ...
              to: primaryPortfolioLink,
              className: "w-full h-12 inline-flex items-center justify-center rounded-xl bg-primary text-white font-bold hover:bg-slate-800 dark:hover:bg-accent-teal transition-all shadow-lg shadow-primary/20",
              children: primaryPortfolioLabel
            }), /*#__PURE__*/React.createElement(Link, {
              to: "/free-trial",
              className: "mt-3 w-full h-12 inline-flex items-center justify-center rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold hover:border-primary dark:hover:border-accent-teal hover:text-primary dark:hover:text-accent-teal transition-all",
              children: "Start Free Trial"
            }), /*#__PURE__*/React.createElement(Link, {
              to: "/contact",
              className: "mt-3 w-full h-12 inline-flex items-center justify-center rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold hover:border-primary dark:hover:border-accent-teal hover:text-primary dark:hover:text-accent-teal transition-all",
              children: "Talk to Specialist"
            })]
          })]
        })]
      }), jsxs("section", {
        children: [jsxs("div", {
          ...
          children: [jsx("h2", {
            ...
            children: "Relevant Case Studies"
          }), /*#__PURE__*/React.createElement(Link, {
            to: "/portfolio",
          ...
          children: showcaseProjects.map(project => {
            ...
            return jsxs(Link, {
              ...
              "data-analytics-cta": `service_detail_case_study_${project.id}`,
              "data-analytics-section": "service_detail_case_studies_grid",
              className: "group rounded-2xl overflow-hidden bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all",
              children: [jsxs("div", {
                className: "relative",
                children: [/*#__PURE__*/React.createElement(CoverMedia, {
                ...
                }), (project.hasVideo || coverIsVideo) && jsx("div", {
                ...
                children: [jsxs("div", {
                  ...
                  className: "inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-[0.12em] text-primary dark:text-accent-teal",
                  children: ["View Case Study", /*#__PURE__*/React.createElement(ArrowUpRight, {
                    size: 14
                  })]
                })]
              })]
