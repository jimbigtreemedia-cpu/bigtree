...
import { NOT_FOUND_SEO, SEO_DEFAULT, ROUTE_SEO, getPortfolioSeo, getServiceSeo } from "../seo.js";
...
const resolveSeo = async (pathname) => {
  ...
  if (normalizedPath.startsWith("/portfolio/")) {
    ...
    try {
      ...
      if (project) return getPortfolioSeo(project);
    } catch (error) {
    }
    return NOT_FOUND_SEO;
  }
